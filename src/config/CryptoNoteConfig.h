...
namespace CryptoNote
{
    namespace parameters
    {
        ...
        const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX = 6995;
        ...
        const uint64_t GENESIS_BLOCK_TIMESTAMP = 1572359740;
    ...
    const int RPC_DEFAULT_PORT = 10453;

    const int SERVICE_DEFAULT_PORT = 10454;
    ...
    const char *const SEED_NODES[] = {
        "145.239.77.62:10452", // nxnjz-ov
	"116.203.28.96:10452", // nxnjz-he
    };
} // namespace CryptoNote
